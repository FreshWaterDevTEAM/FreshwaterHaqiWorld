...
- 音波视效：坚守者生物 / 坚守者哈气用原版青色；基础/升级/强化（金铁钻阶）及其它生物用换色音波（需客户端模组）
...
- `fhw-plugin-2.0.11.jar`
- `fhw-client-2.0.11.jar`
- `fhw-resourcepack-2.0.11.zip`
